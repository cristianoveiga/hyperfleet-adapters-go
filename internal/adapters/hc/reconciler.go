...
func (r *Reconciler) Reconcile(ctx context.Context, clusterID string) (common.Result, error) {
	...
	mwInput := manifest.Input{
		...
		GCPProjectID:                 cluster.Spec.Platform.ProjectID,
		GCPRegion:                    cluster.Spec.Platform.Region,
		GCPNetwork:                   cluster.Spec.Platform.Network,
		GCPSubnet:                    cluster.Spec.Platform.Subnet,
		GCPEndpointAccess:            cluster.Spec.Platform.EndpointAccess,
		WIFProjectNumber:             cluster.Spec.Platform.WorkloadIdentity.ProjectNumber,
		WIFPoolID:                    cluster.Spec.Platform.WorkloadIdentity.PoolID,
		WIFProviderID:                cluster.Spec.Platform.WorkloadIdentity.ProviderID,
		NodePoolEmail:                cluster.Spec.Platform.WorkloadIdentity.ServiceAccountsRef.NodePool,
		ControlPlaneEmail:            cluster.Spec.Platform.WorkloadIdentity.ServiceAccountsRef.ControlPlane,
		CloudControllerEmail:         cluster.Spec.Platform.WorkloadIdentity.ServiceAccountsRef.CloudController,
		StorageEmail:                 cluster.Spec.Platform.WorkloadIdentity.ServiceAccountsRef.Storage,
		ImageRegistryEmail:           cluster.Spec.Platform.WorkloadIdentity.ServiceAccountsRef.ImageRegistry,
		NetworkEmail:                 cluster.Spec.Platform.WorkloadIdentity.ServiceAccountsRef.Network,
